...
#[inline]
fn is_android_back_key(event: &winit::event::KeyEvent) -> bool {
    #[cfg(target_os = "android")]
    {
        ...
        matches!(
            event.logical_key,
            WinitKey::Named(NamedKey::GoBack | NamedKey::BrowserBack | NamedKey::Escape)
        )
    }
...
impl MasonryState<'_> {
    ...
    pub fn handle_window_event(
        ...
        match event {
            WinitWindowEvent::KeyboardInput { event, .. } if is_android_back_key(&event) => {
